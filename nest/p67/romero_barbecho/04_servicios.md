...
![Imagen productController](\assets/04productController.png)

### 2. Captura completa de

`products.service.ts`

![Imagen ProductService](\assets/04productService.png)

### 3. Explicación breve:

* ¿Por qué se utiliza un servicio?
Se utiliza para concentrar la lógica de negocio en un solo lugar.
Esto facilita el mantenimiento, la reutilización y la escalabilidad del código.

* ¿Cómo funciona la inyección de dependencias?
NestJS inyecta automáticamente las dependencias mediante el constructor.
Esto reduce el acoplamiento y permite un código más limpio y testeable.

* ¿Por qué el controlador debe ser mínimo?
Porque solo debe recibir peticiones HTTP y delegar la lógica al servicio.
Esto cumple el principio de responsabilidad única y evita código desordenado.

* ¿Cómo esto beneficia al modelo MVCS?
Separa claramente Model, Controller y Service.
Mejora la organización, mantenimiento y crecimiento del proyecto.
