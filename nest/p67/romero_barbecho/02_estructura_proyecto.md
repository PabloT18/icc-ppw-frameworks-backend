...
![imagen de la estructura](\ssets\02paso1.png)
...
---
![imagen archivo](\assets\02paso2.png)
...
![imagen del arbo en la terminal](\assets\02paso3.png)

### 4. Explicación breve escrita por el estudiante

* ¿Cómo entiendo la arquitectura modular?
La arquitectura modular consiste en dividir la aplicación en partes independientes llamadas módulos, donde cada módulo se encarga de una funcionalidad específica, como usuarios, productos o autenticación.

* ¿Qué relación hay entre controller, service y módulo?
El controller recibe las solicitudes, el service contiene la lógica del negocio y el módulo se encarga de unir y organizar estos componentes para que trabajen juntos.

* ¿Por qué separar dominios mejora la mantenibilidad?
Porque permite hacer cambios en una parte del sistema sin afectar a las demás, el código es más claro, más fácil de probar y de mantener a largo plazo.
