...
![product.entity.ts](assets/Captura%20de%20ProductEntity.jpeg)

## **11.2. Captura de ProductsService**
Screenshot del método `create()` con programación funcional
![product.entity.ts](assets/Captura%20de%20ProductsService.jpeg)
...
ORDER BY id;
```
![product.entity.ts](assets/11.3%20Captura%20de%20PostgreSQL.jpeg)

## **11.4. Capturas de Postman/Thunder Client**
* POST creando un producto
![POST](assets/Post05.jpeg)

* GET listando productos
![GET](assets/Get05.jpeg)

* PUT/PATCH actualizando
![PUT](assets/Put05.jpeg)
![PATCH](assets/Patch05.jpeg)

* DELETE eliminando
![DELETE](assets/Delete05.jpeg)
