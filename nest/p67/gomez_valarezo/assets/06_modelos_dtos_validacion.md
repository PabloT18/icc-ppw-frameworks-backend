...
![Versión de Postman](DTOvalidacion1.png)

![Versión de Postman](DTOvalidacion2.png)

![Versión de Postman](DTOvalidacion3.png)

2. Captura del modelo de dominio Product

![Versión de Postman](dominioProduct1.png)
![Versión de Postman](dominioProduct2.png)

3. Captura de error JSON al enviar producto inválido

![Versión de Postman](ErrorJSON.png)

4. Captura de CRUD funcionando con datos válidos

![Versión de Postman](Postman1.png)
![Versión de Postman](Postman2.png)
![Versión de Postman](Postman3.png)
![Versión de Postman](Postman4.png)
![Versión de Postman](Postman5.png)
![Versión de Postman](Postman6.png)