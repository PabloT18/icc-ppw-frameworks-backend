...
![alt text](assets/actualizar.jpeg)
![alt text](assets/agregar.jpeg)
![alt text](assets/user.jpeg)
...
Los DTO de entrada y salida se usan para separar tu base de datos de la interfaz externa, garantizando tres cosas:
...
La entidad no debe devolverse directamente porque expone la estructura interna de tu base de datos

* cómo funciona el mapper

Un Mapper funciona como un "traductor" o puente que copia automáticamente los datos de un objeto a otro