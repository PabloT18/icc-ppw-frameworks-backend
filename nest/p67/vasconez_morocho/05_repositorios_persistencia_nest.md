...
![alt text](assets/CapturaPosgresql5.png)

## **11.4. Capturas de Postman/Thunder Client**
* POST creando un producto

![alt text](assets/creandoProductos.png)

* GET listando productos

![alt text](assets/obtenerProductos.png)

* PUT/PATCH actualizando

![alt text](assets/actualizandoPUT.png)

* DELETE eliminando

![alt text](assets/eliminandoProducto.png)
