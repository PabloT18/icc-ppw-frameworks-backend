...
![alt text](./assets/Bruno1.png)
![alt text](./assets/PATCH_Actualizar.png)
![alt text](./assets/POST_Agregar.png)
![alt text](./assets/Get_User1.png)
![alt text](./assets/GET_Users.png)
![alt text](./assets/GET_Status.png)
...
![archivo](./assets/users_controllers_ts.png)
...
Porque controlan qué datos recibe y qué datos devuelve la API, evitando campos innecesarios
* por qué la entidad no debe devolverse a la API
Porque la entidad representa la base de datos y puede exponer información interna o sensible.
* cómo funciona el mapper
Convierte la entidad en un DTO (y viceversa), seleccionando y transformando solo los campos necesarios.
