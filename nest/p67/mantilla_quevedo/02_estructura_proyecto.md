...
![estructura](./assets/Nest2_1.jpeg)
Debe visualizarse:
...
Es una arquitectura usada para la programacion limpia en un programa, en donde gracias a esta se tiene mejor escalabilidad

* qué relación hay entre controller, service y módulo

trabajan en conjunto porque el modulo agrupa, el controller maneja las peticiones del usuario o cliente y finalmente el servicio maneja la logica

* por qué separar dominios mejora la mantenibilidad

gracias a esto, en caso que el programa vaya creciendo se puede dar una mejor matencion debido a la organizacion previa, que permite el crecimiento de este sin ningun problema
---
