...
![dtos](assets/capturas/practicas06/06_create.png)

2. Captura del modelo de dominio Product
![product](assets/capturas/practicas06/06_product.png)

3. Captura de error JSON al enviar producto inválido
![json](assets/capturas/practicas06/06_fallar.png)

4. Captura de CRUD funcionando con datos válidos
![json](assets/capturas/practicas06/06_crud.png)

*GET del producto*
![get](assets/capturas/practicas06/06_get.png)

*GET por ID*
![id](assets/capturas/practicas06/06_getid.png)

*PATCH*
![id](assets/capturas/practicas06/06_patch.png)

*DELETE*
![id](assets/capturas/practicas06/06_del.png)

*GET sin productos, después de DELETE*
![id](assets/capturas/practicas06/06_del_get.png)
