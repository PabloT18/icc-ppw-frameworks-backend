...
![404](assets/capturas/practicas07/07_404.png)
- Captura 2: Error 409 (conflicto de negocio)

1. Se crea un producto
![negocio](assets/capturas/practicas07/07_negocio1.png)
2. Conflicto de negocio, producto con el mismo nombre
![negocio](assets/capturas/practicas07/07_negocio2.png)

- Captura 3: Error 400 (validación con details)
![details](assets/capturas/practicas07/07_details.png)
