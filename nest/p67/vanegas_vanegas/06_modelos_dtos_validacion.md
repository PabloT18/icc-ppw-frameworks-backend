...
![create](./assets/create-produs.png)

partial

![partial](./assets/partial-products.png)

update

![update](./assets/update-producto.png)
...
![create](./assets/create-users.png)


partial

![partial](./assets/partial-users.png)


update

![update](./assets/update-users.png)



2. Captura del modelo de dominio Product

![dominio](./assets/produtsmodel.png)

3. Captura de error JSON al enviar producto inválido

![error](./assets/validarerror.png)

4. Captura de CRUD funcionando con datos válidos

put

![put](./assets/valiput.png)

post

![post](./assets/valipost.png)

get

![get](./assets/valiget.png)

delete

![delet](./assets/validelete.png)

pacth

![pacth](./assets/valipatch.png)
