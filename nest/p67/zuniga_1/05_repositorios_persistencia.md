...
![product entity](assets/05/product-entity.png)

## **11.2. Captura de ProductsService**

Screenshot del método `create()` con programación funcional

![create method service](assets/05/create-method.png)
...
![select](assets/05/select-products.png)

## **11.4. Capturas de Postman/Thunder Client**

- POST creando un producto

![create product](assets/05/create-product.png)

- GET listando productos

![list products](assets/05/list-products.png)

- PUT/PATCH actualizando

![update product](assets/05/update-product.png)
![partial update](assets/05/partial-update-product.png)

- DELETE eliminando

![delete product](assets/05/delete-product.png)
