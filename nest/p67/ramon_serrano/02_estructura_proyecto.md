...
---
![alt text](assets\IDEconsola.png)

### 4. Explicación breve escrita por el estudiante

Debe describir:

La arquitectura modular en NestJS permite dividir la aplicación por dominios como users, products y auth, haciendo el proyecto más ordenado y escalable.
El módulo agrupa los controladores y servicios de un dominio, el controlador recibe las peticiones HTTP y el servicio contiene la lógica del negocio.
Separar dominios mejora la mantenibilidad, evita dependencias innecesarias y facilita el trabajo en equipo.
