...
![Codigo de la clase product.entity](./assets/nestproductEntity.png)
...
![Codigo de la clase product.service](./assets/productService05.png)
...
![Listado de productos creados en Bruno](./assets/nestGetProducts.png)

## **11.4. Capturas de Postman/Thunder Client**
* POST creando un producto

![Post de productos realizado en bruno](./assets/nestPostProduct.png)

* GET listando productos


![Get de listado productos realizado en bruno](./assets/nestGetProducts.png)

* PUT/PATCH actualizando

![Put de  productos realizado en bruno](./assets/nestPutProduct.png)

* DELETE eliminando

![Delete de  productos realizado en bruno](./assets/nestDelete1.png)

![Delete de  productos realizado en bruno](./assets/nestDeleteProductComprobacion.png)
---
