...
![Codigo de Products Dtos](./assets/nestDtos.png)

2. Captura del modelo de dominio Product

![Codigo de Product Module](./assets/nestproductModule.png)

3. Captura de error JSON al enviar producto inválido

![Producto con un ingreso de valor negatico ](./assets/nesterror400.png)

4. Captura de CRUD funcionando con datos válidos

![Bruno crear un producto](./assets/nestPostProduct.png)
