...
En este proyecto, el servicio (`ProductsServiceImpl`) se encarga de:
- Crear productos
- Actualizar productos
- Actualizar parcialmente productos
- Eliminar productos
- Aplicar reglas de negocio
- Manipular la lista de productos

El controlador **no contiene lógica**, solo delega al servicio.

Esto permite:
- Reutilizar la lógica en distintos controladores
- Evitar duplicación de código
- Mantener el controlador simple
- Facilitar pruebas unitarias
...
Model	Entidades y estructuras de datos (Products)
View	DTOs de respuesta (ProductsResponseDto)
Controller	Manejo de peticiones HTTP
Service	Lógica de negocio
Ventajas principales de MVCS:
...
Cada capa tiene una única responsabilidad, lo que reduce errores y mejora la calidad del código.

* por qué el controlador ahora está más limpio

Gracias al uso de servicios, el controlador:

  No manipula datos directamente

  No contiene reglas de negocio

  No realiza validaciones complejas

  No gestiona listas ni búsquedas

El controlador solo:

  Recibe la petición HTTP

  Obtiene parámetros y DTOs
