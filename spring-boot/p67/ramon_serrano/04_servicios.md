...
La entidad Product contiene más información de la necesaria para el cliente, como createdAt, por eso no se expone directamente.
Los DTOs controlan qué datos entran y salen de la API, y el mapper se encarga de transformar la entidad en un DTO de respuesta.
El servicio concentra la lógica de negocio y el controlador solo enruta solicitudes, cumpliendo la arquitectura MVCS.
