...
Para centralizar la lógica del negocio y evitar que el controlador haga más de lo necesario.

¿Qué ventajas aporta MVCS?
Mejora la organización del código, facilita el mantenimiento y permite escalar el proyecto.

¿Por qué el controlador ahora está más limpio?
Porque solo maneja las peticiones HTTP y delega la lógica al servicio.
