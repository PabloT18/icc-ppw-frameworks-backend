...
![Versión de Java](ProductEntity.png)
![Versión de Java](ProductEntity2.png)
## 2. Caputra de `ProductosRepository.java`

![Versión de Java](ProductRepository.png)

## 3. Capturas de los 5 productos creados en PostgreSQL (DBeaver, VSCode, etc) Sentencia SQL
![Versión de Java](Postman.png)
![Versión de Java](postgreSQL.png)