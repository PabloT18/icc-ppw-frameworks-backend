...
![Versión de Java](cf60baf0-02b7-4c2e-90e3-5e71dccff8dd.jpg)
...
![Versión de Java](02f83c95-48ab-4dff-95b2-d1dd3d462ff7.jpg)

### 3. Captura del endpoint `/api/status` funcionando en el navegador o Postman o Bruno

Debe incluir la respuesta JSON.

![Versión de Java](fa8c0ba7-cf57-4ecd-aa1f-82ff11de46b8.jpg)
...
![Versión de Java](570013c8-a25f-4a0d-9101-91c85bd96ef7.jpg)
### 5. Explicación breve escrita por el estudiante

Debe describir:

* qué entendió sobre el funcionamiento del endpoint
- Entendí que el endpoint funciona gracias a la anotación @RestController, que permite responder directamente con datos en formato JSON, y a @GetMapping, que vincula la URL con el método Java.

* y sobre la función general de Spring Boot en la 
* creación del servidor

En cuanto al servidor, la función principal de Spring Boot es agilizar el despliegue al incluir un contenedor Tomcat embebido, lo que permite iniciar el servicio web automáticamente en el puerto 8080 sin necesidad de instalaciones ni configuraciones externas complejas.
