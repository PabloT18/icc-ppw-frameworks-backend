...
![Versión de Java](CreateProductDto.png)
![Versión de Java](UpdateProductDto.png)
![Versión de Java](PartialUpdateProductDto.png)

2. Captura del modelo de dominio completo
![Versión de Java](Product.png)
![Versión de Java](Product2.png)
![Versión de Java](Product3.png)
![Versión de Java](Product4.png)


3. Captura de la respuesta de error al enviar un POST inválido

![Versión de Java](Postman(post).png)

4. Captura del CRUD de productos validado correctamente

![Versión de Java](Crud1.png)
![Versión de Java](Crud2.png)
![Versión de Java](Crud3.png)
![Versión de Java](Crud4.png)
![Versión de Java](Crud5.png)
![Versión de Java](Crud6.png)