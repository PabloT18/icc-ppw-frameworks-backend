...
* Porque permiten organizar el proyecto de forma clara, facilitan el mantenimiento y hacen que la aplicación sea más escalable.

* Se relacionan porque los controllers reciben las peticiones, los services procesan la lógica del negocio y los repositories gestionan el acceso a la base de datos.

* El problema que evita es el desorden del código, la duplicación de lógica y errores al modificar o ampliar el sistema.
