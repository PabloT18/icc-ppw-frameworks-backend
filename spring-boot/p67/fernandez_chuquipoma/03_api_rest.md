...
* GET /api/products
![arbol](./assets/apiproducts.png)


* GET /api/products/:id
![arbol](./assets/products1.png)


* POST /api/products
![arbol](./assets/products2.png)

* PUT /api/products/:id
![arbol](./assets/products3.png)

* PATCH /api/products/:id
![arbol](./assets/products4.png)

* DELETE /api/products/:id
![arbol](./assets/products5.png)


### 2. Captura del archivo

`products.controller.java`
![arbol](./assets/controller.png)

![arbol](./assets/controller2.png)
...
Porque cumplen propósitos diferentes. El de entrada solo contiene los datos necesarios para crear o actualizar (omitiendo el ID), mientras que el de salida incluye el ID y omite datos sensibles.

* por qué la entidad nunca se devuelve al cliente
Evita exponer datos internos (como contraseñas o fechas de creación) y permite que la base de datos cambie sin afectar la respuesta que recibe el cliente.

* cómo funciona el mapper
Actúa como un traductor. Toma los datos de un objeto (ej. Entidad) y los copia manualmente a otro (ej. DTO) para asegurar que la información se transforme correctamente antes de viajar por la API.