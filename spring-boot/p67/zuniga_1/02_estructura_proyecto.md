...
![structure-app](assets/02/structure-app.png)
...
![main-java](assets/02/main-java.png)
...
![terminal-structure](assets/02/tree-structure.png)
...
La estructura modular nos permite mantener un código legible, mantenible y flexible. Esto nos permite escalar el proyecto.
Controller, es la parte que el cliente puede obtener o modificar. El servicio son las herramientas para realizar algunas acciones. Módulo, es la división de las funcionalidades.
Separar en dominios mejora la mantenibilidad ya que nos permite organizar mejor, hace el código más legible y posible de entender. Esto facilita mucho el desarrollo a futuro.
