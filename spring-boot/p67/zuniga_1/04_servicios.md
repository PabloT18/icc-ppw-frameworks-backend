...
![products controller](assets/04/product-controller.png)
...
El servicio centraliza la lógica de negocio, separándola del controlador. Esto permite reutilizar esa lógica en múltiples controladores sin duplicar código.

**¿Qué ventajas aporta MVCS?**

MVCS (Model-View-Controller-Service) proporciona:

- Separación clara de responsabilidades
- Código más mantenible y escalable
- Facilita pruebas unitarias del servicio sin levantar el servidor
- Preparación para integrar bases de datos reales (JPA/Repositories)
