...
```json
{
  "errors": ["El nombre es obligatorio", "El email es inválido"]
}
```
...
1. Captura de DTOs con validaciones
   ...
   ![create dto](assets/06/create-dto.png)

   ![partial update dto](assets/06/partial-update-dto.png)

   ![update dto](assets/06/update-dto.png)

2. Captura del modelo de dominio completo

   ![domain model](assets/06/domain-model.png)

3. Captura de la respuesta de error al enviar un POST inválido

   ![error post](assets/06/post-error.png)

4. Captura del CRUD de productos validado correctamente

   ![create product](assets/06/create-product.png)

   ![update product](assets/06/update-product.png)

   ![partial update product](assets/06/partial-update-product.png)
