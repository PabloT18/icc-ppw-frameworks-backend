...
* GET /api/products
![GET products](./assets/PRODUCTS.png)
* GET /api/products/:id
![GET products/1](<./assets/GET product1.png>)
* POST /api/products
...
![controller part1](./assets/controllers1.png)
![controller part2](./assets/controllers2.png)
![controller part3](./assets/controllers3.png)
### 3. Explicación breve

Incluyendo:

* por qué existen DTOs distintos para entrada y salida
porque no siempre la información que se envía es la misma que se recibe y así se puede manejar mejor la API.
* por qué la entidad nunca se devuelve al cliente
porque no se debe exponer toda la información de la base de datos, esto causaria problemas de seguridad.
* cómo funciona el mapper
transforma datos para actuar como un traductor entre DTOs y entidades.
