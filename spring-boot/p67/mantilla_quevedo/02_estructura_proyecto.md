...
Porque te da una estructura clara en la que puedes ubicar facilmente al agrupar los 
elementos de un módulo según un tema en especifico para que no haya tantas lineas de codigo en un solo archivo ni muchos imports en un solo archivo.
**cómo se relacionan controllers, services y repositories**
Se relacionan según la arquitectura en capas, donde cada una tiene una responsabilidad entre presentación, lógica de negocio y acceso a datos.
**qué problema evita mantener una estructura clara**
Evitar el desorden y el acoplamiento excesivo del código.