...
## Salida esperada
![Captura 2: Servidor Spring Boot ejecutándose](assets/cap2.jpeg)
...
![Captura 3: Endpoint /api/status funcionando](assets/cap3.png)
...
![Captura 1: Verificación de Java](assets/cap1.png)
...
![Captura 2: Servidor Spring Boot iniciado](assets/cap2.jpeg)
...
![Captura 4: Estructura de carpetas](assets/cap4.png)
...
Entendí que un endpoint es una ruta específica del servidor donde se reciben o se envían datos. Cada endpoint tiene una función definida, por ejemplo, obtener información, guardar datos o actualizar registros. Cuando el cliente hace una petición a esa ruta, el controlador ejecuta el método correspondiente y devuelve una respuesta.

También comprendí que Spring Boot facilita la creación del servidor, porque configura automáticamente muchas partes internas del proyecto. Permite crear endpoints de forma sencilla usando anotaciones y organiza el código en controladores, servicios y repositorios, haciendo que el servidor sea más fácil de construir, ejecutar y mantener.