...
![products.controller.java](./assets/products.controller.javaSB.png)

### 3. Captura completa del archivo

`ProductServiceImpl.java`
![ProductServiceImp part1](./assets/ServiceImp1.png)
![ProductServiceImp part2](./assets/ServiceImp2.png)

### 4. Explicación breve

* por qué se usa un servicio
Se usa para concentrar la lógica que antes estaba en el controlador al Servicio para separar responsabilidades,
mantener el código más ordenado y reutilizable.

* qué ventajas aporta MVCS
Mejora la organización del proyecto al separar las responsibilidades del Modelo,
Vista, Controlador y Servicio aparte de que facilita la comprensión del código.

* por qué el controlador ahora está más limpio
Porque solo quedo reducido a enrutar solicitudes y llamar al servicio.
