...
![Captura IDE](assets/capturaIDE.png)
...
![Captura Fundamentos](assets/capturaFundamentos.png)
...
![Captura Trees](assets/capturaTrees.png)
---

### 4. Explicación breve

El tener módulos separados nos permite organizar el proyecto por sus funcionalidades, facilitandonos así el poder mantenerlo, tambien facilita el trabajo en equipo y el crecimiento de nuestro sistema.

Los controllers reciben las peticiones, los services en cambio se encargan de manejar la lógica de negocio y los repositories son aquellos que acceden a los datos, manteniendo así responsabilidades claras para cada uno.

El tener esta estructura ordenada evita código desorganizado, dependencias innecesarias y dificultades para escalar o mantener nuestro proyecto.
