...
![constructo](./assets/constrctor.png)

### 3. Captura completa del archivo

`ProductServiceImpl.java`

![impleserve](./assets/implemserve.png)
...
En esta práctica se usa un **servicio** porque permite concentrar la **lógica de negocio** (reglas, validaciones y operaciones CRUD) en una sola capa, evitando repetir código y facilitando el mantenimiento del proyecto. Además, aplicar **MVCS** aporta orden y escalabilidad, ya que separa responsabilidades: el **Controlador** gestiona rutas y recibe DTOs, el **Servicio** procesa la lógica, y las **Entidades/Mappers/DTOs** manejan la estructura y transformación de datos. Por esta separación, el **controlador ahora está más limpio**, porque ya no implementa la lógica interna; únicamente enruta solicitudes y delega al servicio, lo que hace el código más claro, testeable y preparado para integrar una base de datos en el futuro.
