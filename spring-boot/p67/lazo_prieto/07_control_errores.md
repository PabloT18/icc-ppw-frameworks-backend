...
![product-query](capturas/practicas07/07_400.png)
- Captura 2: Error 409 (conflicto de negocio)
Conflicto lógico (Crear una regla de negocio como: "No se puede crear un producto con nombre duplicado" Crear otra no nombre duplicado)
![product-query](capturas/practicas07/07_logico.png)

- Captura 3: Error 400 (validación con details)
Eror de validación (enviar datos mal formados)
![details](capturas/practicas07/07_validacion.png)
