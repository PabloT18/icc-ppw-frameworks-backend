...
![dto-validacion](capturas/practicas06/06_create.png)
![dto-validacion](capturas/practicas06/06_updater.png)
![dto-validacion](capturas/practicas06/06_partial.png)
![dto-validacion](capturas/practicas06/06_resp.png)

2. Captura del modelo de dominio completo
![modelo](capturas/practicas06/06_dominio.png)

3. Captura de la respuesta de error al enviar un POST inválido
![post](capturas/practicas06/06_invalido.png)


4. Captura del CRUD de productos validado correctamente
![crud](capturas/practicas06/06_crud1.png)
![crud](capturas/practicas06/06_crud2.png)
