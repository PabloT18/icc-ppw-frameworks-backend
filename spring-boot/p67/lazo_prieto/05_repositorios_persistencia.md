...
![product-entity](capturas/practica05/05_productentity.png)

## 2. Captura de `ProductosRepository.java`
![product-repository](capturas/practica05/05_productrepository.png)

## 3. Capturas de los 5 productos creados en PostgreSQL (DBeaver, VSCode, etc) Sentencia SQL
![product-query](capturas/practica05/05_query.png)
