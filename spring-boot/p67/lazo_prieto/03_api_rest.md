...
![productos-sin-agregar](capturas/practica03/get-products.png)

* GET /api/products/:id

![verificar-agregado](capturas/practica03/verifiicando-producto.png)

* POST /api/products

![agregarndo-producto](capturas/practica03/post-agregacion.png)

* PUT /api/products/:id

![modificacion-completa](capturas/practica03/modificaionCompleta.png)

* PATCH /api/products/:id

![modificacion-partial](capturas/practica03/modificacion-parcial.png)

* DELETE /api/products/:id

![eliminacion](capturas/practica03/eliminacion.png)
...
![codigo](capturas/practica03/code.png)
...
Porque no siempre se recibe la misma información que se devuelve.

Al crear o actualizar, el cliente envía solo algunos datos.

Al responder, el servidor devuelve solo lo que quiere mostrar.

Los DTOs permiten controlar qué datos entran y cuáles salen, evitando errores y problemas de seguridad.
...
Porque la entidad es interna del backend.

Puede tener datos sensibles (como password).

Puede cambiar sin que el cliente deba enterarse.

No representa exactamente lo que el cliente necesita ver.

Por eso, la entidad se queda en el servidor y el cliente solo recibe DTOs.
