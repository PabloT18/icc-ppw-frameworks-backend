...
![alt text](capturas/practica01/javaVersion.png)

### 2. Captura del servidor Spring Boot ejecutándose

Debe mostrarse:

![alt text](capturas/practica01/node-corriendo.png)
...
![alt text](capturas/practica01/end-point.png)
...
![alt text](capturas/practica01/ls.png)

Mostrando:

* el archivo `StatusController.java`

![alt text](capturas/practica01/statusControllerJava.png)
...
La función general de Spring Boot es simplificar la plomería. Me da un esqueleto de proyecto ya configurado para que, literalmente, solo tenga que escribir la lógica de negocio y sepa que el servidor se levantará sin yo tocar archivos de configuración extensos o XMLs. Por eso es tan rápido empezar.
