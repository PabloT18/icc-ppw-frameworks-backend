...
![CreateProductsDto.java](assets/CreateProductsDto.java.jpeg)
![PartialUpdateProductsDto.java](assets/PartialUpdateProductsDto.java.jpeg)
![ProductsResponseDto.java](assets/ProductsResponseDto.java.jpeg)
![UpdateProductsDto.java](assets/UpdateProductsDto.java.jpeg)
2. Captura del modelo de dominio completo
![Dominio](assets/Dominio1.jpeg)
![Dominio](assets/Dominio2.jpeg)
![Dominio](assets/Dominio3.jpeg)
3. Captura de la respuesta de error al enviar un POST inválido
![postInvalido](assets/crudValido.jpeg)
4. Captura del CRUD de productos validado correctamente
![crudValido](assets/crudValido.jpeg)
