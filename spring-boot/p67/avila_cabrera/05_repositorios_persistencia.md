...
![ProductosEntity.java](assets/ProductosEntity.java.jpeg)
## 2. Caputra de `ProductosRepository.java`
![ProductosRepository.java](assets/ProductosRepository.java.jpeg)
## 3. Capturas de los 5 productos creados en PostgreSQL (DBeaver, VSCode, etc) Sentencia SQL
![Productos](assets/productos%20creados.jpeg)
