...
![Imagen productEntity](assets/05productentity.png)
![Imagen productEntity](assets/05productentity02.png)

## 2. Caputra de `ProductosRepository.java`
![Imagen productRepository](assets/05repository.png)

## 3. Capturas de los 5 productos creados en PostgreSQL (DBeaver, VSCode, etc) Sentencia SQL
![Imagen setencias](assets/05crear.png)