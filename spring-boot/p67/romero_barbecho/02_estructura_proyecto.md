...
utils/
```
![imagen mostrando la estructura](\assets\02paso1.png)
---
...
![Imagen del archivo](\assets\02paso2.png)
...
![Imagen de arbol desde la terminal](\assets\02paso3.png)
...
Porque permite organizar mejor el proyecto, hacer cambios sin afectar otras partes y trabajar más fácil en equipo.

* ¿Cómo se relacionan controllers, services y repositories?
El controller recibe las peticiones del usuario, el service procesa la lógica del negocio y el repository se encarga de acceder a la base de datos.

* ¿Qué problema evita mantener una estructura clara?
Evita confusión en el código, errores repetidos, dependencias mal hechas y hace que el proyecto sea más fácil de mantener a largo plazo.
