...
![alt text](<nest/p67/alvarez_villa/assets/06 spirng 1.jpeg>)

2. Captura del modelo de dominio completo

![alt text](<nest/p67/alvarez_villa/assets/06 spring 2.jpeg>)
![alt text](<nest/p67/alvarez_villa/assets/06 spring 3.jpeg>)
![alt text](<nest/p67/alvarez_villa/assets/06 spring 4.jpeg>)

3. Captura de la respuesta de error al enviar un POST inválido

![alt text](<nest/p67/alvarez_villa/assets/06 spring 5.jpeg>)

4. Captura del CRUD de productos validado correctamente

![alt text](<nest/p67/alvarez_villa/assets/06 spring 6.jpeg>)