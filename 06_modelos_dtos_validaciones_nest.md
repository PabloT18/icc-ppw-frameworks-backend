...
![alt text](<nest/p67/alvarez_villa/assets/06 NETS 1.jpeg>)
![alt text](<nest/p67/alvarez_villa/assets/06 NETS 2.jpeg>)
![alt text](<nest/p67/alvarez_villa/assets/06 NEST 3.jpeg>)

2. Captura del modelo de dominio Product

![alt text](<nest/p67/alvarez_villa/assets/06 NEST 4.jpeg>)
![alt text](<nest/p67/alvarez_villa/assets/06 NEST 5.jpeg>)

3. Captura de error JSON al enviar producto inválido

![alt text](<nest/p67/alvarez_villa/assets/06 NEST 6.jpeg>)

4. Captura de CRUD funcionando con datos válidos

![alt text](<nest/p67/alvarez_villa/assets/06 NEST 7.jpeg>)
