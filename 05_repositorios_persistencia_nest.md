...
![alt text](<nest/p67/alvarez_villa/assets/05 NEST 1.jpeg>)

## **11.2. Captura de ProductsService**

![alt text](<nest/p67/alvarez_villa/assets/05 NEST 2.jpeg>)
![alt text](<nest/p67/alvarez_villa/assets/05 NEST 2.1.jpeg>)


## **11.3. Captura de PostgreSQL**

![alt text](<nest/p67/alvarez_villa/assets/05 NEST 3.jpeg>)

## **11.4. Capturas de Postman/Thunder Client**

* POST creando un producto

![alt text](<nest/p67/alvarez_villa/assets/05 NEST 7.jpeg>)

* GET listando productos

![alt text](<nest/p67/alvarez_villa/assets/05 NEST 4.jpeg>)

* PUT

![alt text](<nest/p67/alvarez_villa/assets/05 NEST 5.jpeg>)

* PATCH actualizando

![alt text](<nest/p67/alvarez_villa/assets/05 NEST 6.jpeg>)

* DELETE eliminando

![alt text](<nest/p67/alvarez_villa/assets/05 NEST 8.jpeg>)
