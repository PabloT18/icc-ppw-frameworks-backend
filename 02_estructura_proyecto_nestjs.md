...
![alt text](nest/p67/alvarez_villa/assets/Imagen12.png)
...
![alt text](nest/p67/alvarez_villa/assets/Imagen13.png)
...
![alt text](nest/p67/alvarez_villa/assets/Imagen14.png)
...
- La arquitectura modular la entiendo como una forma de organizar una aplicación dividiéndola en partes independientes llamadas módulos, donde cada módulo representa una funcionalidad o dominio específico del sistema. Esto permite que el proyecto esté mejor estructurado y sea más fácil de entender y mantener.

Qué relación hay entre controller, service y módulo
- La relación entre el controller, el service y el módulo es que todos forman parte de una misma funcionalidad. El controller se encarga de recibir las peticiones del usuario, el service procesa la lógica del negocio y el módulo agrupa y conecta estos componentes para que trabajen juntos dentro de la aplicación.

Por qué separar dominios mejora la mantenibilidad
- Separar los dominios mejora la mantenibilidad porque los cambios se realizan solo en el módulo correspondiente sin afectar al resto del sistema. Además, facilita la detección de errores, la reutilización del código y permite escalar la aplicación de forma ordenada conforme crecen los requerimientos.
---
