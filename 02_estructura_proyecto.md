...
![alt text](nest/p67/alvarez_villa/assets/Imagen1.png)
...
![alt text](nest/p67/alvarez_villa/assets/Imagen10.png)
...
![alt text](nest/p67/alvarez_villa/assets/Imagen11.png)
...
Por qué es importante tener módulos separados
 - Tener los módulos separados permite organizar el sistema por funcionalidades, haciendo el código más ordenado, mantenible y escalable. Cada módulo se encarga de una responsabilidad específica, lo que facilita el trabajo en equipo, las pruebas y futuras modificaciones sin afectar otras partes del sistema.
 
Cómo se relacionan controllers, services y repositories

- Los controllers reciben las solicitudes del usuario y gestionan las respuestas.
Los services contienen la lógica de negocio y procesan la información.
Los repositories se encargan del acceso a los datos y la comunicación con la base de datos.
Esta separación permite que cada capa cumpla un rol específico y se comunique de forma ordenada.


Qué problema evita mantener una estructura clara

- Mantener una estructura clara evita código desordenado, dependencias innecesarias, duplicación de lógica y errores difíciles de rastrear. Además, reduce el riesgo de afectar todo el sistema al realizar cambios y mejora la legibilidad del proyecto.
